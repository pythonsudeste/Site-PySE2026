...
export default function Submissao() {
    return(<section className="Submissao">
        <h3>Chamada para palestras</h3>
        <h4>Quer compartilhar conhecimento com a comunidade?</h4>
        <h4>Seja palestrante e faça parte!</h4>
        ...
        <div className="Submissao.linha2">
            ...
            <div className="Submissao.linha2.direita">
                ...
                <div className="Submissao.linha2.direita.item">
                    ...
                    <p>Apresentações rápidas e dinâmicas sobre qualquer tópico.</p>
                    <p>*Submissões durante o evento</p>
                </div>
            </div>
